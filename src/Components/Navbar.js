                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto w-100 justify-content-end">
                            <li class="nav-item active">
                                <a class="nav-link" id="navlink"> <Link to="/about" smooth={true} duration={150}>ABOUT</Link></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="navlink"><Link to="/skills">SKILLS / CERTIFICATIONS</Link></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="navlink"><Link to="/experience" smooth={true} duration={150}>EXPERIENCE / QUALIFICATION </Link></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="navlink"><Link to="contact" smooth={true} duration={150}>CONTACT </Link></a>
                            </li>
